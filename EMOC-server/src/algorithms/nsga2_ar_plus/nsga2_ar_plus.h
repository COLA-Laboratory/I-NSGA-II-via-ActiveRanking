...
/***********************
 * NSGA-II/AR-PLUS aims to actively decide when to ask the DM for preference information
 *
 *
 */
...
namespace emoc {
    ...
    class NSGA2_AR_PLUS : public Algorithm
    {
    public:
        typedef struct
        {
        ...
        NSGA2_AR_PLUS(Problem *problem, int thread_num);
        virtual ~NSGA2_AR_PLUS();
