...
(
config=configFiles/NEMO_0/mdtlz/mdtlz1_5d.txt
...
(
config=configFiles/NEMO_0/mdtlz/mdtlz2_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/mdtlz/mdtlz3_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/mdtlz/mdtlz4_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
((0))&&{
(
config=configFiles/NEMO_0/dtlz/dtlz1_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz3_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz4_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz1_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz2_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz3_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz4_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz1_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz2_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz3_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/dtlz/dtlz4_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/mdtlz/mdtlz1_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/mdtlz/mdtlz2_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/mdtlz/mdtlz3_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/mdtlz/mdtlz4_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz1_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz2_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz3_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz4_3d.txt
./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz1_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz2_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz3_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz4_5d.txt
./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz1_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz2_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz3_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
...
(
config=configFiles/NEMO_0/minus_dtlz/minus_dtlz4_8d.txt
./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s`\
&&
echo "./EMOC -file $config -W 1,1,1,1,1,1,1,1 >> ../log/log.`date +%s` is done."
)&
